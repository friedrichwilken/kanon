//! `hybrid`: reciprocal rank fusion of the `bm25` and `dense` page rankings.
...
/// How many of each ranking [`HybridBackend`] fuses.
...
/// `hybrid`: reciprocal rank fusion of the `bm25` and `dense` page rankings, over
