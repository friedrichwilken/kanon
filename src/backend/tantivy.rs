//! `bm25-tantivy`: the same units as `bm25`, scored by tantivy's own BM25
//! (`k1` 1.2, `b` 0.75).
...
/// over the same retrieval units as [`Index`]: title, heading and body are indexed
